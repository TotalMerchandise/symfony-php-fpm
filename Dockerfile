...
# Install packages required for pecl
RUN apk add --update --no-cache --virtual .build-deps autoconf make g++ \
...
RUN docker-php-ext-install pdo pdo_mysql opcache mysqli exif
